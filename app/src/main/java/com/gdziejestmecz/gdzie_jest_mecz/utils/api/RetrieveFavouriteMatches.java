...
public class RetrieveFavouriteMatches extends AsyncTask<String, Void, ArrayList<Match>> {
    public AsyncFavouriteMatchesListResponse delegate = null;
    ...
    protected void onPostExecute(ArrayList<Match> matchData) {
        ...
        delegate.retrieveFavouriteMatchesProcessFinished(matchData);
    }

    private ArrayList<Match> getMatches(){
        ArrayList<Match> matches = new ArrayList<Match>();
        try {
            String result = Api.get(ServerInfo.getRootUrl() + ServerInfo.getEndpointFavMatches());
